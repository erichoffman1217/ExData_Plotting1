...
par(mfrow=c(2,2))
#Plot1
with(power, plot(date_time, Global_active_power, ylab='Global Active Power', type ='l', xlab=""))
#Plot2
with(power, plot(date_time, Voltage, ylab='Voltage', type ='l', xlab=""))
#Plot3
...
#Plot4
with(power, plot(date_time, Global_reactive_power, ylab='Global_reactive_power', type ='l', xlab=""))
dev.off()
